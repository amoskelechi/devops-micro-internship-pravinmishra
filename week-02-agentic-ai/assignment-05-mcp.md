...
![Screenshot 1 — GitHub token creation page showing the selected scopes (`repo`, `read:user`) — token value must NOT be visible](screenshots/assignment5-task1-screenshot1.png)
...
![Screenshot 2 — `.mcp.json` open in VS Code showing the full configuration](screenshots/assignment5-task2-screenshot1.png)
...
![Screenshot 3 — `settings.local.json` open in VS Code showing the `env` section — **blur or cover the actual GitHub token value**](screenshots/assignment5-task3-screenshot1.png)
...
![Screenshot 4 — `/mcp` output showing `github: connected`](screenshots/assignment5-task4-screenshot1.png)
...
![Screenshot 5 — Claude's response showing the GitHub MCP tool call and the retrieved README.md content.](screenshots/assignment5-task5-screenshot1_a.png)

![Screenshot 5 — Claude's response showing the GitHub MCP tool call and the retrieved README.md content.](screenshots/assignment5-task5-screenshot1_b.png)
