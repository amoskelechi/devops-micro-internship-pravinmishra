...
![Screenshot 1 — Your fork page with your username and `devops-micro-internship-interviews` visible in the browser URL](screenshots/assignment-codetrack5-task0-screenshot1.png)
...
![Screenshot 2 — Output of `git config --global --get credential.helper` (HTTPS) or `ssh -T git@github.com` (SSH) showing successful authentication — never show your token or private key](screenshots/assignment-codetrack5-task1-screenshot1.png)
...
![Screenshot 3 — Output of `git remote -v` showing `origin` pointing to your fork and `upstream` pointing to `pravinmishraaws/devops-micro-internship-interviews`
](screenshots/assignment-codetrack5-task2-screenshot1.png)
...
![Screenshot 4 — Output of `git status` showing `pull_request.md` modified before staging](screenshots/assignment-codetrack5-task3-screenshot1.png)

---

#### Screenshot 5 — Output of `git commit`

![Screenshot 5 — Output of `git commit`](screenshots/assignment-codetrack5-task3-screenshot2.png)
...
![Screenshot 6 — Output of `git push -u origin feature-readme-update` showing a successful push](screenshots/assignment-codetrack5-task4-screenshot1.png)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

![Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner](screenshots/assignment-codetrack5-task4-screenshot2.png)
...
![Screenshot 8 — Pull Request creation page showing the correct base repository, base branch, head repository, compare branch, and title](screenshots/assignment-codetrack5-task5-screenshot1.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![Screenshot 9 — Successfully created Pull Request page with the PR number visible](screenshots/assignment-codetrack5-task5-screenshot2.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/432`
...
`https://www.linkedin.com/posts/amosolijo_devops-opensource-git-activity-7487605088824360962-1iqS?utm_source=share&utm_medium=member_desktop&rcm=ACoAACeeKxUBHCmo50w2w4CI7SAJd2ZqQPhPsCQ`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![Screenshot — LinkedIn post showing your successfully created Pull Request](screenshots/assignment-codetrack5-linkedin-post.png)
...
`https://github.com/amoskelechi/devops-micro-internship-interviews`
