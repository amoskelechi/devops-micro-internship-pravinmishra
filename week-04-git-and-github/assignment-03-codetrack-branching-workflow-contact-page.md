...
![Screenshot 1 - Output](screenshots/assignment-codetrack3-task1-screenshot1.png)
...
![Screenshot 2 - Output of git checkout feature/contact-page and git branch](screenshots/assignment-codetrack3-task2-screenshot1.png)
...
![Screenshot 3 - Output of 'ls' showing `contact.html`](screenshots/assignment-codetrack3-task3-screenshot1.png)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot 4 - Output of `git commit`](screenshots/assignment-codetrack3-task3-screenshot2.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Screenshot 5 — Output of `git log --oneline -3` showing the new commit](screenshots/assignment-codetrack3-task3-screenshot3.png)
...
![Screenshot 6 — Output of `git status` showing `index.html` as modified before staging](screenshots/assignment-codetrack3-task4-screenshot1.png)

---

#### Screenshot 7 — Output of `git commit`

![Screenshot 7 — Output of `git commit`](screenshots/assignment-codetrack3-task4-screenshot2.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`](screenshots/assignment-codetrack3-task4-screenshot3.png)
...
![Screenshot 9 — Terminal showing the checkout and `ls` output, proving `contact.html` is absent](screenshots/assignment-codetrack3-task5-screenshot1.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link](screenshots/assignment-codetrack3-task5-screenshot2.png)
...
![Screenshot 11 — Output of `git merge feature/contact-page`](screenshots/assignment-codetrack3-task6-screenshot1.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot 12 — Output of `ls` showing `contact.html` after the merge](screenshots/assignment-codetrack3-task6-screenshot2.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch](screenshots/assignment-codetrack3-task6-screenshot3.png)
...
![Screenshot 14 — Full output of `git log --oneline --graph --decorate --all`](screenshots/assignment-codetrack3-task7-screenshot1.png)
...
![Screenshot 15 (Optional) — Output showing `feature/contact-page` deleted and no longer listed](screenshots/assignment-codetrack3-task8-screenshot1.png)
