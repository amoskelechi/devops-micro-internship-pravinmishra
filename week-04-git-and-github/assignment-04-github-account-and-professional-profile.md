...
![Screenshot 1 — GitHub dashboard or Home page showing you're signed in, with your username visible](screenshots/assignment-codetrack4-task1-screenshot.png)
...
![Screenshot 2 (Optional but Recommended) — Your GitHub profile with `https://github.com/<username>` visible in the browser address bar](screenshots/assignment-codetrack4-task1-screenshot2.png)
...
![Screenshot 3 — GitHub Trending page visible in the browser](screenshots/assignment-codetrack4-task2-screenshot1.png)

---

#### Screenshot 4 — A repository page showing the Star button in the Starred state

![Screenshot 4 — A repository page showing the Star button in the Starred state](screenshots/assignment-codetrack4-task2-screenshot2.png)

---

#### Screenshot 5 — Your forked repository page with your username and repository name visible in the URL

![Screenshot 5 — Your forked repository page with your username and repository name visible in the URL](screenshots/assignment-codetrack4-task2-screenshot3.png)
...
![Screenshot 6 — Your public GitHub profile showing your username and professional bio](screenshots/assignment-codetrack4-task3-screenshot1.png)
