...
![Screenshot 1 - Output of 'node -v && npm -v](screenshots/assignment2-screenshot1.png)
...
![Screenshot 2 - Output of 'systemctl status nginx --no-pager showing Active (running)](screenshots/assignment2-screenshot2.png)
...
![Screenshot 3 - Output of `ls` inside the `my-react-app` directory showing project files](screenshots/assignment2-screenshot3.png)
...
![Screenshot 4 — `nano App.js` open showing your full name and date filled in](screenshots/assignment2-screenshot4.png)
...
![Screenshot 5 — Output of `ls` inside `my-react-app` showing the `build/` folder generated](screenshots/assignment2-screenshot5.png)
...
![Screenshot 6 — Output of `ls /var/www/html/` showing the deployed build contents](screenshots/assignment2-screenshot6.png)
...
![Screenshot 7 — Output of `systemctl is-active nginx` showing `active`](screenshots/assignment2-screenshot7.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config](screenshots/assignment2-screenshot8.png)
...
![Screenshot 9 — Output of `curl ifconfig.me` showing the server's public IP address](screenshots/assignment2-screenshot9.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible](screenshots/assignment2-screenshot10.png)
...
`https://www.linkedin.com/posts/amosolijo_dmibypravinmishra-agenticai-claudecode-ugcPost-7483336747280584704-o5Ur/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACeeKxUBHCmo50w2w4CI7SAJd2ZqQPhPsCQ`

---

#### Screenshot — LinkedIn post showing the deployed application

![Screenshot — LinkedIn post showing the deployed application](screenshots/Linkedinpost.png)
