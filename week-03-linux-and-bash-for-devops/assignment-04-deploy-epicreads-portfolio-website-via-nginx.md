...
![Screenshot 0 - Nginx active and enabled](screenshots/assignment4-task0-screenshot.png)
...
![Screenshot 1 - Extracted Pravin-Mishra-Portfolio-main folder](screenshots/assignment4-task1-screenshot.png)
...
![Screenshot 2 - Footer updated with name, group, week, date](screenshots/assignment4-task2-screenshot.png)
...
![Screenshot 3 - nginx -t syntax ok](screenshots/assignment4-task3-screenshot1.png)

---

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![Screenshot 4 - Deployed website files in /var/www/html](screenshots/assignment4-task3-screenshot2.png)
...
![Screenshot 5 - Public IP address](screenshots/assignment4-task4-screenshot1.png)

---

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![Screenshot 6 - Live website with footer ownership proof](screenshots/assignment4-task4-screenshot2.png)
...
![Screenshot 7 - nginx enabled on boot](screenshots/assignment4-task5-screenshot1.png)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![Screenshot 8 - curl localhost 200 OK](screenshots/assignment4-task5-screenshot2.png)
...
![Screenshot - LinkedIn post](screenshots/assignment4-linkedinpost-screenshot.png)
